...
public class Product {
    ...
    //constructor
    public Product (String product_image, int product_id, String product_name, String product_description, double product_price, String product_category, int product_quantity) {
